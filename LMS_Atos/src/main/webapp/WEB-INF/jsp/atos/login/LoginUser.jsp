...
<script type="text/javaScript">
	 ...
	 * 쿠키에 저장된 아이디를 가져와서 폼에 자동으로 입력하고, 기본 로그인 유형을 설정합니다.
	...
	// ----------------------------------------------------------------------------------------------------
	// 로그인 유형 관련 함수: 로그인 유형을 선택하거나 보여주는 함수
	// ----------------------------------------------------------------------------------------------------
	
	/* fnLoginTypeSelect(objName)
	 * - objName: 선택된 로그인 유형의 ID (문자열)
	 * 
	 * 이 함수는 사용자가 로그인 유형(수강생, 강사, 관리자) 중 하나를 선택했을 때 호출됩니다.
